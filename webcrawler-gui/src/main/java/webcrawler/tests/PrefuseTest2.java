 ...
 */
public class PrefuseTest2 extends JFrame {
...
//        JComponent graphview = demo(null, "name");
    ...
    public static JComponent demo(String datafile, String label) {
        ...
        return demoFromGraph(g, label);
    }

    public static JComponent demoFromGraph(Graph g, String label) {
...
//                VisualItem.FILLCOLOR, ColorLib.rgb(200,200,255));
    ...
    public static void main(String[] args) {
        PrefuseTest2 main = new PrefuseTest2();
