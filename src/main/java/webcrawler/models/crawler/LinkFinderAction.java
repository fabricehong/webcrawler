...
public class LinkFinderAction extends RecursiveAction {
    ...
    public LinkFinderAction(String fromUrl, String url, LinkHandler cr) {
            ...
            try {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (!extracted.extractLink().isEmpty()
                        ...
                        actions.add(new LinkFinderAction(this.url, extracted.extractLink(), cr));
                    }
                }
                cr.addVisited(url);
